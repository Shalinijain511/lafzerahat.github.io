        ...
        public static function buildTabHtml($tab)
        {
          ...
          <div class="action_box box box-solid box-' . $box_type . '" id="body_' . $tab_id . '">
            <div class="box-header with-border">
              <h3 class="box-title"><button class="btn" title="drag tab for change order"> <i class="fa fa-arrows-v"> </i> </button> ';
                ...
                if(isset($tab['tab_visible_role']) && !empty($tab['tab_visible_role'])){
                    $html .= '
                <span data-toggle="tooltip" title="' . __('Visible to '.implode(',',$tab['tab_visible_role']), 'wpuser') . '" class="badge bg-aqua" data-original-title="' . __('Visible to '.implode(',',$tab['tab_visible_role']), 'wpuser') . '">
